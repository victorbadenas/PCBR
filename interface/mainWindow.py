...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(750, 850, 80, 23))
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 711, 861))
        ...
        self.groupBox.setGeometry(QtCore.QRect(30, 30, 671, 201))
        self.groupBox.setObjectName("groupBox")
        self.widget = QtWidgets.QWidget(self.groupBox)
        self.widget.setGeometry(QtCore.QRect(61, 41, 186, 131))
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(30, 560, 671, 80))
        self.groupBox_4.setObjectName("groupBox_4")
        # Low
        self.radioButton_15 = QtWidgets.QRadioButton(self.groupBox_4)
        self.radioButton_15.setGeometry(QtCore.QRect(180, 40, 100, 21))
        self.radioButton_15.setObjectName("radioButton_15")
        # Medium
        self.radioButton_14 = QtWidgets.QRadioButton(self.groupBox_4)
        self.radioButton_14.setGeometry(QtCore.QRect(286, 40, 100, 21))
        self.radioButton_14.setObjectName("radioButton_14")
        # High
        self.radioButton_16 = QtWidgets.QRadioButton(self.groupBox_4)
        self.radioButton_16.setGeometry(QtCore.QRect(392, 40, 100, 21))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(30, 330, 671, 221))
        self.groupBox_3.setObjectName("groupBox_3")
        self.widget1 = QtWidgets.QWidget(self.groupBox_3)
        self.widget1.setGeometry(QtCore.QRect(31, 41, 225, 158))
        ...
        # Work
        self.radioButton_11 = QtWidgets.QRadioButton(self.widget1)
        ...
        self.radioButton_13 = QtWidgets.QRadioButton(self.widget1)
        self.radioButton_13.setObjectName("radioButton_13")
        self.verticalLayout.addWidget(self.radioButton_13)
        # Other programming
        self.radioButton_23 = QtWidgets.QRadioButton(self.widget1)
        ...
        # Vertical Labels
        self.widget10 = QtWidgets.QWidget(self.tab_2)
        self.widget10.setGeometry(QtCore.QRect(0, 60, 171, 231))
        self.widget10.setObjectName("widget10")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.widget10)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.label = QtWidgets.QLabel(self.widget10)
        self.label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label.setObjectName("label")
        self.verticalLayout_3.addWidget(self.label)
        self.label_2 = QtWidgets.QLabel(self.widget10)
        self.label_2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_2.setObjectName("label_2")
        self.verticalLayout_3.addWidget(self.label_2)
        self.label_3 = QtWidgets.QLabel(self.widget10)
        ...
        self.label_5 = QtWidgets.QLabel(self.widget10)
        self.label_5.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_5.setObjectName("label_5")
        self.verticalLayout_3.addWidget(self.label_5)
        self.label_6 = QtWidgets.QLabel(self.widget10)
        self.label_6.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_6.setObjectName("label_6")
        self.verticalLayout_3.addWidget(self.label_6)
        self.label_7 = QtWidgets.QLabel(self.widget10)
        self.label_7.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_7.setObjectName("label_7")
        self.verticalLayout_3.addWidget(self.label_7)
        self.label_8 = QtWidgets.QLabel(self.widget10)
        self.label_8.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_8.setObjectName("label_8")
        self.verticalLayout_3.addWidget(self.label_8)

        # column labels
        self.widget11 = QtWidgets.QWidget(self.tab_2)
        self.widget11.setGeometry(QtCore.QRect(180, 30, 531, 17))
        self.widget11.setObjectName("widget11")
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout(self.widget11)
        self.horizontalLayout_10.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.label_9 = QtWidgets.QLabel(self.widget11)
        self.label_9.setObjectName("label_9")
        self.horizontalLayout_10.addWidget(self.label_9)
        self.label_10 = QtWidgets.QLabel(self.widget11)
        self.label_10.setObjectName("label_10")
        self.horizontalLayout_10.addWidget(self.label_10)
        self.label_11 = QtWidgets.QLabel(self.widget11)
        self.label_11.setObjectName("label_11")
        self.horizontalLayout_10.addWidget(self.label_11)
        self.label_12 = QtWidgets.QLabel(self.widget11)
        self.label_12.setObjectName("label_12")
        self.horizontalLayout_10.addWidget(self.label_12)
        self.label_13 = QtWidgets.QLabel(self.widget11)
        ...
        # Rather
        self.radioButton_36 = QtWidgets.QRadioButton(self.widget9)
        ...
        # Very
        self.radioButton_37 = QtWidgets.QRadioButton(self.widget9)
        ...
        # Little
        self.radioButton_39 = QtWidgets.QRadioButton(self.widget6)
        ...
        # Somewhat
        self.radioButton_40 = QtWidgets.QRadioButton(self.widget6)
        ...
        # Rather
        self.radioButton_41 = QtWidgets.QRadioButton(self.widget6)
        ...
        # Very
        self.radioButton_42 = QtWidgets.QRadioButton(self.widget6)
        ...
        self.widget2.setGeometry(QtCore.QRect(180, 150, 526, 23))
        self.widget2.setObjectName("widget2")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.widget2)
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        # Not at all
        self.radioButton_43 = QtWidgets.QRadioButton(self.widget2)
        ...
        # Little
        self.radioButton_44 = QtWidgets.QRadioButton(self.widget2)
        ...
        # Somewhat
        self.radioButton_45 = QtWidgets.QRadioButton(self.widget2)
        ...
        # Rather
        self.radioButton_46 = QtWidgets.QRadioButton(self.widget2)
        ...
        # Very
        self.radioButton_47 = QtWidgets.QRadioButton(self.widget2)
        ...
        # Little
        self.radioButton_49 = QtWidgets.QRadioButton(self.widget8)
        ...
        # Somewhat
        self.radioButton_50 = QtWidgets.QRadioButton(self.widget8)
        ...
        # Rather
        self.radioButton_51 = QtWidgets.QRadioButton(self.widget8)
        ...
        # Very
        self.radioButton_52 = QtWidgets.QRadioButton(self.widget8)
        ...
        # Editing videos/photos/music
        self.widget4 = QtWidgets.QWidget(self.tab_2)
        self.widget4.setGeometry(QtCore.QRect(180, 208, 526, 23))
        self.widget4.setObjectName("widget4")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout(self.widget4)
        self.horizontalLayout_7.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        # Not at all
        self.radioButton_53 = QtWidgets.QRadioButton(self.widget4)
        ...
        # Little
        self.radioButton_54 = QtWidgets.QRadioButton(self.widget4)
        ...
        # Somewhat
        self.radioButton_55 = QtWidgets.QRadioButton(self.widget4)
        ...
        # Rather
        self.radioButton_56 = QtWidgets.QRadioButton(self.widget4)
        ...
        # Very
        self.radioButton_57 = QtWidgets.QRadioButton(self.widget4)
        ...
        # Little
        self.radioButton_59 = QtWidgets.QRadioButton(self.widget7)
        ...
        # Somewhat
        self.radioButton_60 = QtWidgets.QRadioButton(self.widget7)
        ...
        # Rather
        self.radioButton_61 = QtWidgets.QRadioButton(self.widget7)
        ...
        # Very
        self.radioButton_62 = QtWidgets.QRadioButton(self.widget7)
        ...
        self.widget3.setGeometry(QtCore.QRect(180, 266, 526, 23))
        self.widget3.setObjectName("widget3")
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout(self.widget3)
        self.horizontalLayout_9.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        # Not at all
        self.radioButton_63 = QtWidgets.QRadioButton(self.widget3)
        ...
        # Little
        self.radioButton_64 = QtWidgets.QRadioButton(self.widget3)
        ...
        # Somewhat
        self.radioButton_65 = QtWidgets.QRadioButton(self.widget3)
        ...
        # Rather
        self.radioButton_66 = QtWidgets.QRadioButton(self.widget3)
        ...
        # Very
        self.radioButton_67 = QtWidgets.QRadioButton(self.widget3)
        ...
        self.widget12.setGeometry(QtCore.QRect(20, 40, 633, 131))
        self.widget12.setObjectName("widget12")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.widget12)
        self.verticalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        # Microsoft Office Suite
        self.checkBox = QtWidgets.QCheckBox(self.widget12)
        self.checkBox.setObjectName("checkBox")
        self.verticalLayout_4.addWidget(self.checkBox)
        # Tensorflow/PyTorch/Keras
        self.checkBox_2 = QtWidgets.QCheckBox(self.widget12)
        self.checkBox_2.setObjectName("checkBox_2")
        self.verticalLayout_4.addWidget(self.checkBox_2)
        # Compilers
        self.checkBox_3 = QtWidgets.QCheckBox(self.widget12)
        ...
        self.checkBox_4 = QtWidgets.QCheckBox(self.widget12)
        self.checkBox_4.setObjectName("checkBox_4")
        self.verticalLayout_4.addWidget(self.checkBox_4)
        # Low-performance games: Minecraft, Fortnite: Battle Royale
        self.checkBox_5 = QtWidgets.QCheckBox(self.widget12)
        self.checkBox_5.setObjectName("checkBox_5")
        self.verticalLayout_4.addWidget(self.checkBox_5)
        self.application_checkboxes = [self.checkBox, self.checkBox_2, self.checkBox_3, self.checkBox_4, self.checkBox_5]
    ...
    def build_profile_str(self):
        keys = ['experience', 'wfh', 'primary_use', 'budget', 'replace_frequency', 'optical_drive']
        values = []
    ...
    def build_constraints_str(self):
        keys = ['cpu_pref', 'gpu_pref', 'min_ram']
        values = []
        for key in keys:
            for idx, rb in enumerate(self.radio_groups[key]):
                if rb.isChecked():
    ...
    def print_solutions(self, proposed_solutions, columns, index):
        ...
        msg.setText(text)
        msg.setInformativeText(dataframe.to_markdown())
        msg.setWindowTitle("Solutions")
        msg.setDetailedText("Is the latter proposed solution satisfactory:")
